...
class ChangeStatusTrip implements ShouldQueue
{
    ...
    public function updateStatus()
    {
        ...
        if ($this->trip->start_date <= $dateNow && $this->trip->end_date > $dateNow && $this->trip->statusTrip != TripCases::InWay->value) {
            $this->trip->statusTrip = TripCases::InWay->value;

        } elseif ($this->trip->end_date <= $dateNow && $this->trip->statusTrip != TripCases::Completed->value) {
